  ...
  return (
    <footer ref={footerRef}>
      ...
      <div className="form-container">
        ...
        <textarea name="message" id="textarea" rows="10" cols="50" required placeholder='Podaj szczegóły' maxLength="1500" ></textarea>
      ...
      <div className='contact-data-container'>
        ...
        <div className='social-media'>
          <Link to="https://www.facebook.com/share/1Jjg3ttwW9/?mibextid=wwXIfr" target="_blank">
          ...
          <Link to="https://www.instagram.com/leanservicepl?igsh=ejQxdXBkMGJpaG54" target="_blank">
          ...
          <Link to="https://allegro.pl/uzytkownik/LeanStore" target="_blank">
